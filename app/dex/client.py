...
class DexscreenerClient(EasyModel):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.client.config.base_url = "https://api.dexscreener.io/latest"
        pass
    ...
    def get_token_pair(self, chain: str, address: str) -> Optional[TokenPair]:
        ...
        """
        response: requests.Response = self.client.api_request(HttpRequestMethod.GET, f"dex/pairs/{chain}/{address}")
    ...
    async def get_token_pair_async(self, chain: str, address: str) -> Optional[TokenPair]:
        ...
        """
        response: aiohttp.ClientResponse = await self.client.api_request_async(HttpRequestMethod.GET, f"dex/pairs/{chain}/{address}")
        return TokenPair(**response["pair"]) if response["pair"] else None
