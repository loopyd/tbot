import asyncio
import pytest
from src.dexscreener.client import DexscreenerClient
from src.dexscreener.models import DefiNetwork
...
def test_get_pairs_async(dexscreener_client, mocker):
    ...
    mock_response.return_value = {"data": [{"base_token": {"symbol": "SOL"}, "quote_token": {"symbol": "USDC"}}]}
